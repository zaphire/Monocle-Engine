...
namespace Native
{
	namespace Windows
	{
		...
		void Backend::ShowBuffer()
		{
			SwapBuffers(this->hDC);
		}

		long Backend::GetMilliseconds()
		{
		...
		bool Backend::CreatePlatformWindow(const char* title, int width, int height, int bits, bool fullscreenflag)
		{
		...
		void Backend::KillPlatformWindow()								// Properly Kill The Window
		{
		...
		LRESULT CALLBACK Backend::WndProc(	HWND	hWnd,			// Handle For This Window
