...
namespace Engine
{
    ...
    Math::Math(lua_State * L, bool byuser)
    {
        if (byuser)
		{
    ...
    /* Binding variables */
    const char* Math::ClassName = "Engine.Math";
    const char* Math::Inherits = "Object";
    const Bindings<Math>::FunctionType Math::Functions[] =
    {
        {0}
    };
    const Bindings<Math>::PropertyType Math::Properties[] =
    {
        {0}
    };
    int (__cdecl *Math::Dispatcher)(lua_State * L) = &(Bindings<Math>::FunctionDispatch);
} 
