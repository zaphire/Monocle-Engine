...
#ifndef CLASS_Engine_LowLevelException
#define CLASS_Engine_LowLevelException
...
namespace Engine
{
    ...
    class LowLevelException : public Engine::Exception
    {
        ...
        public: LowLevelException(lua_State * L, bool byuser);
        ...
        public: static const Bindings<LowLevelException>::FunctionType Functions[];
        public: static const Bindings<LowLevelException>::PropertyType Properties[];
