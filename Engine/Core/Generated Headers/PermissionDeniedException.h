...
#ifndef CLASS_Engine_PermissionDeniedException
#define CLASS_Engine_PermissionDeniedException
...
namespace Engine
{
    ...
    class PermissionDeniedException : public Engine::EngineException
    {
        /* Variable declarations */
        public: static const char* Message;

        /* Method and constructor declarations */
        public: PermissionDeniedException(std::string resource);
        public: PermissionDeniedException(lua_State * L, bool byuser);
        ...
        public: static const Bindings<PermissionDeniedException>::FunctionType Functions[];
        public: static const Bindings<PermissionDeniedException>::PropertyType Properties[];
