...
#ifndef CLASS_Engine_PathNotFoundException
#define CLASS_Engine_PathNotFoundException
...
namespace Engine
{
    ...
    class PathNotFoundException : public Engine::EngineException
    {
        /* Variable declarations */
        public: static const char* Message;

        /* Method and constructor declarations */
        public: PathNotFoundException(std::string path);
        public: PathNotFoundException(lua_State * L, bool byuser);
        ...
        public: static const Bindings<PathNotFoundException>::FunctionType Functions[];
        public: static const Bindings<PathNotFoundException>::PropertyType Properties[];
