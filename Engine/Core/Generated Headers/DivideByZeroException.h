...
#ifndef CLASS_Engine_DivideByZeroException
#define CLASS_Engine_DivideByZeroException
...
namespace Engine
{
    ...
    class DivideByZeroException : public Engine::LowLevelException
    {
        ...
        public: DivideByZeroException(lua_State * L, bool byuser);
        ...
        public: static const Bindings<DivideByZeroException>::FunctionType Functions[];
        public: static const Bindings<DivideByZeroException>::PropertyType Properties[];
