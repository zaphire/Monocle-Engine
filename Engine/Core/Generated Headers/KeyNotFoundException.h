...
#ifndef CLASS_Engine_KeyNotFoundException
#define CLASS_Engine_KeyNotFoundException
...
namespace Engine
{
    ...
    class KeyNotFoundException : public Engine::InterpreterException
    {
        ...
        public: KeyNotFoundException(lua_State * L, bool byuser);
        ...
        public: static const Bindings<KeyNotFoundException>::FunctionType Functions[];
        public: static const Bindings<KeyNotFoundException>::PropertyType Properties[];
