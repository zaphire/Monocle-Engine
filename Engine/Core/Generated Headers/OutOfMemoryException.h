...
#ifndef CLASS_Engine_OutOfMemoryException
#define CLASS_Engine_OutOfMemoryException
...
namespace Engine
{
    ...
    class OutOfMemoryException : public Engine::LowLevelException
    {
        ...
        public: OutOfMemoryException(lua_State * L, bool byuser);
        ...
        public: static const Bindings<OutOfMemoryException>::FunctionType Functions[];
        public: static const Bindings<OutOfMemoryException>::PropertyType Properties[];
